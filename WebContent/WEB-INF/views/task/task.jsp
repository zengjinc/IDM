			...
			<div class="col-md-10 subject">
				...
				<form class="form-horizontal center-block" role="form">
					<div class="form-group">
						<label for="userUuid" class="col-md-5 control-label">计划任务标识</label>
						<div class="col-md-3">
							<input type="text" class="form-control" id="userUuid" placeholder="">
						</div>
					</div>
					<div class="form-group">
						<label for="userName" class="col-md-5 control-label">计划任务类型</label>
						<div class="col-md-3">
				...
				<table class="table table-bordered table-hover table-striped">
					...
					<tbody>
						<tr>
							...
							<td>test</td>
							<td>test</td>
							<td><a href="totask/taskdetail.action">查看</a></td>
						</tr>
						<tr>
							<td>test</td>
							<td>test</td>
